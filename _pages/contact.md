...
<div class="post">
  <article>
    ...
    <form action="https://formspree.io/f/mzdndzop" method="POST" class="contact-form">
      ...
      <!-- Redirects here after a successful submission instead of Formspree's default page -->
      <input type="hidden" name="_next" value="{{ site.url }}{{ '/contact/success/' | relative_url }}">

      <!-- Honeypot field to deter simple bots; real users never see or fill this in -->
